...
export default function EditorPage() {
  ...
  async function handleSaveCollaborators() {
    ...
    try {
      ...
      setInviteError(
        error instanceof Error ? error.message : "Unable to update collaborators.",
      );
    }
  }
    ...
    <main className="app-shell">
      <section className="hero-panel">
        <div>
          ...
          <p className="hero-copy">
            Owners keep edit permissions. Multiple collaborators can open the same
            document in read-only mode through shared usernames or a shareable invite link.
          </p>
        </div>
        ...
        <div className="role-controls">
          <div className="role-summary">
            ...
            <span className="summary-pill">
              {presence.viewerConnected
                ? `${presence.viewerCount} viewer${presence.viewerCount === 1 ? "" : "s"} connected`
            ...
            <>
              ...
              <label className="invite-link-field">
                ...
                <input
                  ...
                  onChange={(event) => setSharedUsersInput(event.target.value)}
              ...
              <div className="invite-card">
                <div>
                  ...
                  <p className="panel-note">
                    ...
                    join in read-only mode and leave comments without taking over another viewer.
                  </p>
                </div>
