...
function ThreeDotMenu({ onRename, onOpen, onDelete }: { onRename: () => void; onOpen: () => void; onDelete: () => void }) {
      ...
      >
         ...
         {open && (
            <div style={{
               ...
               <button style={menuItemStyle} onClick={() => { setOpen(false); onDelete(); }}>Delete</button>
            </div>
         )}
      </div>
   );
                     ...
                     .map((doc) => (
                        ...
                        >
                           ...
                           {activeTab === "writer" && renamingId !== doc.id && (
                              <ThreeDotMenu onOpen={() => openDoc(doc.id)} onRename={() => startRename(doc)} onDelete={() => deleteDoc(doc.id)} />
                           )}
                        </div>
                     ))}
               </div>
